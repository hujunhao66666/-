...
import com.example.util.IntegrateObject;
...
public class EmployeeController {
    ...
    @RequestMapping("/list")
    public String list(Employee employee, HttpServletResponse response, HttpServletRequest request) throws IOException {
        ...
        List<Employee> postList = employeeService.findEmployees(map);
    ...
    @RequestMapping("/save")
    public String save(@RequestParam(value = "dept_id")Integer dept_id, @RequestParam(value = "pos_id")Integer pos_id,
                       @RequestParam("updateFlag")String updateFlag, Employee employee,
