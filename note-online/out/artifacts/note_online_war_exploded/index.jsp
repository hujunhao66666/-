...
<html>
  <head>
    ...
    <script src="https://labfile.oss.aliyuncs.com/courses/1379/ckeditor.js"></script>
    <style type="text/css">
      body {
        padding: 30px;
        display: flex;
  ...
  <script>
    /*
    * 1. 每次进入页面前，都从后台取最新的数据到前台，在 index 方法里
    * 2. 缓存数据判断，缓存为空，则将后台最新数据赋值。本地缓存  localStorage 自动保存
    * 3. 缓存数据赋值给 texture 值
    * 4. 遇到 texture 值变化，则自动保存
    */
    ...
    function initeditor() {     // 初始化编辑器，设置编辑器的主题样式以及模式
      var editor = CKEDITOR.replace('editor1', {
        ...
        height: 800,  // 外面长方形高多少
        contentsCss: ['https://labfile.oss.aliyuncs.com/courses/1379/contents.css'],   // 有无里面的方格
        allowedContent: true,
